...
namespace Mep.Business.Migrations.Seeds
{
  internal class CcgSeeder : SeederBase
  {
    ...
    internal void SeedData()
    {
      ...
      using var result = _client.
        GetAsync("https://services1.arcgis.com/ESMARspQHYMw9BZ9/arcgis/rest/services/CCG_APR_2019_EN_NC/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json").Result;
