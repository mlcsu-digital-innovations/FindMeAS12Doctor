...
export const oidcConfig: OpenIdConfiguration = {
  ...
  redirectUrl: 'https://fmas12d-dev.azurewebsites.net/',
  ...
  silentRenew: true,
  silentRenewUrl: 'https://fmas12d-dev.azurewebsites.net/silent-renew.html',
 ...
 */
import 'zone.js/dist/zone-error';  // Included with Angular CLI.import { OpenIdConfiguration } from 'angular-auth-oidc-client';
