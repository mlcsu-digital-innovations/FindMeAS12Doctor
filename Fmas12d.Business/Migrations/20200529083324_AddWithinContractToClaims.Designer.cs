...
namespace Fmas12d.Business.Migrations
{
    ...
    [Migration("20200529083324_AddWithinContractToClaims")]
    partial class AddWithinContractToClaims
    {
            ...
            modelBuilder.Entity("Fmas12d.Data.Entities.ContactDetailCcgAudit", b =>
                {
                    ...
                    b.ToTable("ContactDetailCcgsAudit");
                });
            ...
            modelBuilder.Entity("Fmas12d.Data.Entities.Section12LiveRegister", b =>
                {
                    ...
                    b.ToTable("Section12LiveRegisters");
                });
            ...
            modelBuilder.Entity("Fmas12d.Data.Entities.UserAssessmentClaim", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ExportedDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Fmas12d.Data.Entities.UserAvailability", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("OnCallConfirmationReceivedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("OnCallConfirmationSentAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<bool?>("OnCallIsConfirmed")
                        .HasColumnType("bit");

                    b.Property<string>("OnCallRejectedReason")
                        .HasColumnType("nvarchar(max)");
